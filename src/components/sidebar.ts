...
const ICONS = {
  ...
  optimize: `<svg class="sidebar-link-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>`,
};
  ...
  el.innerHTML = `
    <div class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <a class="sidebar-link${state.currentView === 'optimize' ? ' sidebar-link--active' : ''}" data-view="optimize">
          ${ICONS.optimize}
          <span>Optimize</span>
        </a>
